...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_credit_cards_card_number'),
                    'credit_cards', ['card_number'], unique=True)
    op.create_index(op.f('ix_credit_cards_id'),
                    'credit_cards', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_credit_cards_card_number'),
